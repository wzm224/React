...
/***/ function(module, exports, __webpack_require__) {
	...
	var _round = __webpack_require__(97);
	...
	var _more = __webpack_require__(100);
	...
	var routes = {
		path: "/",
		component: _footer2.default, //路由开始显示的页面,
		indexRoute: { component: _index2.default }, //indexRoute用来进行组件的嵌套，不需要嵌套的话可以不写
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			var Ad = __webpack_require__(91);
			var More = __webpack_require__(92);
			var Bg = __webpack_require__(93);
			var Movie = __webpack_require__(94);
			var Like = __webpack_require__(95);
		...
		render: function render() {
			return React.createElement(
				"div",
				{ id: "indexbox", style: CssStyle.section },
				React.createElement(
					"div",
					{ id: "head" },
					"0"
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"li",
					{ style: Css.hdli2 },
					React.createElement("input", { type: "text", style: Css.input, placeholder: "\u8BF7\u8F93\u5165\u67E5\u627E\u5546\u54C1\u3001\u79CD\u7C7B..." }),
					React.createElement(
						"span",
						{ className: "icon", style: Css.search },
						"\uE612"
					)
				),
				React.createElement(
...
/***/ function(module, exports) {
	...
	var Ad = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				"div",
				_defineProperty({ style: CssStyle.banner }, "style", CssStyle.ad),
				React.createElement(
					"div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MineChild = __webpack_require__(99);
	var My = React.createClass({
		...
		render: function render() {
			...
			//console.log(reset)
			if (reset) {
				arr.push(React.createElement(MineChild, { name: reset }));
			}
			return React.createElement(
				"div",
				{ style: StyleSheets.boxB },
				arr
			);
		}
...
/***/ function(module, exports) {
	...
	var MineChild = React.createClass({
		displayName: 'MineChild',
	
		render: function render() {
			//console.log(this.props)
			return React.createElement(
				'div',
				{ style: StyleSheets.mineB },
				React.createElement(
					'div',
					{ style: StyleSheets.mineBox },
					React.createElement(
						'div',
						{ style: StyleSheets.mine1 },
						this.props.name[0].title1
					),
					React.createElement(
						'div',
						{ style: StyleSheets.mine2 },
						React.createElement(
							'div',
							{ style: StyleSheets.mine3 },
							this.props.name[0].d1
						)
					),
					React.createElement(
						'div',
						{ style: StyleSheets.mine4 },
						React.createElement(
							'li',
							{ style: StyleSheets.border },
							this.props.name[0].d2
						),
						React.createElement(
							'li',
							{ style: StyleSheets.border },
							this.props.name[0].d3
						),
						React.createElement(
							'li',
							{ style: StyleSheets.mine5 },
							this.props.name[0].d4
						)
					)
				),
				React.createElement('div', { style: StyleSheets.mine6 }),
				React.createElement(
					'div',
					{ style: StyleSheets.mine7 },
					React.createElement(
						'i',
						{ className: 'iconfont', style: StyleSheets.icon1 },
						'\uE629'
					),
					React.createElement(
						'b',
						null,
						this.props.name[1].title2
					)
				),
				React.createElement(
					'div',
					{ style: StyleSheets.mine8 },
					React.createElement(
						'div',
						{ style: StyleSheets.mine8a },
						React.createElement(
							'i',
							{ className: 'iconfont', style: StyleSheets.i },
							'\uE73F'
						),
						React.createElement(
							'b',
							{ style: StyleSheets.b },
							this.props.name[2].title3
						)
					),
					React.createElement(
						'div',
					...
					React.createElement(
						...
						React.createElement(
							'b',
							{ style: StyleSheets.b },
							this.props.name[2].c2
						)
					),
					React.createElement('div', null)
				),
				React.createElement('div', { style: StyleSheets.mine9 }),
				React.createElement(
					'div',
					{ style: StyleSheets.mine10 },
					React.createElement(
						'i',
						{ className: 'iconfont', style: StyleSheets.icon1 },
						'\uE601'
					...
					React.createElement(
						'b',
						null,
						this.props.name[3].title4
					)
				),
				React.createElement(
					'div',
					{ style: StyleSheets.mine11 },
					React.createElement(
						'li',
						{ style: StyleSheets.mine11a },
						this.props.name[4].title5
					),
					React.createElement(
						'li',
						{ style: StyleSheets.mine11b },
						this.props.name[4].d1
					)
				),
				React.createElement('div', { style: StyleSheets.mine12 }),
				React.createElement(
					'div',
					{ style: StyleSheets.mine13 },
					React.createElement(
						'i',
						{ className: 'iconfont', style: StyleSheets.icon1 },
						'\uE7C8'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MoreChild = __webpack_require__(101);
	var More = React.createClass({
													displayName: "More",
													...
													componentWillMount: function componentWillMount(res) {
																									var This = this;
																									$.ajax({
																																					url: this.props.url,
																																					dataType: "json",
													...
													render: function render() {
																									...
																									if (reset1) {
																																					...
																																					arr1.push(React.createElement(MoreChild, { name: reset1 }));
																									}
	
																									return React.createElement(
																																					"div",
																																					{ id: "boxB", style: StyleSheets.boxB },
																																					arr1
																									);
													}
...
/***/ function(module, exports) {
	...
	var MoreChild = React.createClass({
		displayName: "MoreChild",
	
		render: function render() {
	
			return React.createElement(
				"div",
				{ style: StyleSheets.More },
				React.createElement(
					"div",
					{ style: StyleSheets.MoreA },
					this.props.name[0].title1
				),
				React.createElement(
					"div",
					{ style: StyleSheets.MoreB },
					this.props.name[1].title2
				),
				React.createElement(
					"div",
				...
				React.createElement("div", { style: StyleSheets.MoreC }),
				React.createElement(
					"div",
					{ style: StyleSheets.MoreB },
					this.props.name[5].title6
				...
				React.createElement(
					"div",
					{ style: StyleSheets.MoreB },
					this.props.name[8].title9
				),
				React.createElement(
					"div",
					{ style: StyleSheets.MoreB },
					this.props.name[9].title10
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = React.createClass({
		...
		render: function render() {
			return React.createElement(
				"div",
				{ id: "LaYout", style: css.layout },
				React.createElement(
					"div",
					{ id: "content", style: css.content },
					this.props.children
				),
				React.createElement(
					"ul",
					{ style: css.footbox, id: "foot" },
					React.createElement(
						_reactRouter.Link,
						{ style: css.footlink, to: "/index" },
						React.createElement(
							"li",
							{ style: css.footli },
							React.createElement(
